...
sentuh.innerHTML = "<a class='tombol' onclick='funSentuh()'><svg id='svgheart' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><g transform='translate(2.550170, 3.550158)'><path d='M0.371729633,8.89614246 C-0.701270367,5.54614246 0.553729633,1.38114246 4.07072963,0.249142462 C5.92072963,-0.347857538 8.20372963,0.150142462 9.50072963,1.93914246 C10.7237296,0.0841424625 13.0727296,-0.343857538 14.9207296,0.249142462 C18.4367296,1.38114246 19.6987296,5.54614246 18.6267296,8.89614246 C16.9567296,14.2061425 11.1297296,16.9721425 9.50072963,16.9721425 C7.87272963,16.9721425 2.09772963,14.2681425 0.371729633,8.89614246 Z'></path><path d='M13.23843,4.013842 C14.44543,4.137842 15.20043,5.094842 15.15543,6.435842'></path></g></svg></a><svg class='line' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><g transform='translate(5.000000, 8.500000)'><path d='M14,0 C14,0 9.856,7 7,7 C4.145,7 0,0 0,0'></path></g></svg>";
...
*/
  ...
  function animasiketik(){
    ...
    teks5.style="transform:scale(.9);transition:all .7s ease";
...
function funSentuh(){
  ...
  setTimeout(function() {
        if(fungsi==0){
           ...
           fungsi = 1;
           skrg++;
           if(skrg==2){fungsi=0;setTimeout(animasiketik,1800);wp2.style.transform = "scale(1)";setTimeout(function() {teks4.style="transform:scale(1);transition:all .7s ease";}, 600);}
        }
  }, 100);
}
...
function gantiTeks1nimasi(){
    teks1.classList.remove("itim");
    teks1.classList.add("playpen");
    teks1.style = "font-size: .9rem;line-height: 1.7em;";
  	new TypeIt("#teks1", {
...
document.getElementById("loveIn").onclick = function() {
    ...
    //initom.style="";
    first_stiker.style="transform: scale(1)";
    wp1.style.transform = "scale(1)";
    setTimeout(function() {
        teks3.style.transform = "scale(1)";
    }, 450);

    setTimeout(gantiTeks1, 3500);
...
watermark.textContent = dateNum + " " + month + " " + year + " — Imamny07";
